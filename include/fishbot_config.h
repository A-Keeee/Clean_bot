...
#define CONFIG_DEFAULT_MOTOR0_PARAM_REDUCATION_RATIO "51"    // 双倍频：1124÷(11×2)≈51
#define CONFIG_DEFAULT_MOTOR0_PARAM_PULSE_RATION "22"        // 编码器线数
#define CONFIG_DEFAULT_MOTOR0_PARAM_WHEEL_DIAMETER "65"
#define CONFIG_DEFAULT_MOTOR1_PARAM_REDUCATION_RATIO "51"
#define CONFIG_DEFAULT_MOTOR1_PARAM_PULSE_RATION "22"
#define CONFIG_DEFAULT_MOTOR1_PARAM_WHEEL_DIAMETER "65"
//-------------------------------------默认轮距----------------------------------------------
#define CONFIG_DEFAULT_KINEMATIC_WHEEL_DISTANCE "184"
